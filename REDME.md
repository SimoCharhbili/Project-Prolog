...
```bash
npx create-next-app --ts Project-Prolog
...
- `.nvmrc` - Contains info about which version of Node is used
- `.npmrc` - Contains info about which package manager is used
...
The reason we are using V16 instead of v16 for Node is that incase we want to deploying on Vercel which unfortunately still does not support Node V17+. We will make sure we cnstently upgrade to the most aviliable version. You can follow the progress [here](https://github.com/vercel/community/discussions/37).
...
```json
  "name": "Project-Prolog",
  "author": "Mohamed Charhbili",
  "description": "A Boilerplate Startup For Projects | Typescript | Storybook | Yarn | Tailwind | Preconfigs ...",
  "version": "0.1.0",
  "private": true,
  "license" : "MIT"
...
![Dev Experience](https://res.cloudinary.com/dqse2txyi/image/upload/v1649129725/blogs/Project-Prolog/dev-experience_wznie9.png)
...
We have just added a little bit of extra configuration to make it a bit stricter than it is by default. If you disagree with any of the rules it sets, no need to worry, just notify the group Admin and necessary actions will be taken to adjust to everyone's liking. We configure everything in `.eslintrc.json` which should already exist in your root directory:
...
Now added a new script to `package.json` so we can run Prettier:
...
![VS Code Debugger](https://res.cloudinary.com/dqse2txyi/image/upload/v1649168143/blogs/Project-Prolog/vscode-debugger_x1puqk.png)
...
![Storybook Started](https://res.cloudinary.com/dqse2txyi/image/upload/v1649131564/blogs/Project-Prolog/storybook-started_ydsrdg.png)

And you'll be able to access it on [http://localhost:6006](http://localhost:6006)

![Storybook Main](https://res.cloudinary.com/dqse2txyi/image/upload/v1649131644/blogs/Project-Prolog/storybook-main_yktgqh.png)
...
![Storybook Base Template](https://res.cloudinary.com/dqse2txyi/image/upload/v1649133832/blogs/Project-Prolog/storybook-base-template_uwna7h.png)
...
![Component Directory Structure](https://res.cloudinary.com/dqse2txyi/image/upload/v1649134894/blogs/Project-Prolog/component-directory-structure_ddw1ll.png)
...
![VS Code Find Replace](https://res.cloudinary.com/dqse2txyi/image/upload/v1649134987/blogs/Project-Prolog/vscode-find-replace_ithpow.png)
...
![Storybook Cat Card](https://res.cloudinary.com/dqse2txyi/image/upload/v1649136596/blogs/Project-Prolog/cat-card-storybook_f10yic.png)
...
![Final Masterpiece](https://res.cloudinary.com/dqse2txyi/image/upload/v1649137105/blogs/Project-Prolog/final-masterpiece_cbpxu1.png)
...
![Layout Folders](https://res.cloudinary.com/dqse2txyi/image/upload/v1649187194/blogs/Project-Prolog/layout-folders_g3hzyt.png)
...
If you have any difficulty with this step, feel free to just [take the structure from the repo](https://github.com/alexeagleson/Project-Prolog).
...
![Next Layout 01](https://res.cloudinary.com/dqse2txyi/image/upload/v1649190823/blogs/Project-Prolog/next-layout-01_ijadox.png)

![Next Layout 02](https://res.cloudinary.com/dqse2txyi/image/upload/v1649190823/blogs/Project-Prolog/next-layout-02_v8hoti.png)
...
![Storybook Sidebar](https://res.cloudinary.com/dqse2txyi/image/upload/v1649191018/blogs/Project-Prolog/storybook-sidebar_actilj.png)
...
Once logged in, click `+ New Project` and give Vercel access to your Github repositories. You can give global access, or you can select only the repository you want to deploy. I am going to select this repository called `Project-Prolog`.
...
![Next Configure](https://res.cloudinary.com/dqse2txyi/image/upload/v1649164443/blogs/Project-Prolog/next-configure_dtywld.png)
...
![Successful Deploy](https://res.cloudinary.com/dqse2txyi/image/upload/v1649164722/blogs/Project-Prolog/successful-depoy_pyg2ry.png)
